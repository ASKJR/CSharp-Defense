...
namespace APM.SL
{
    public class Product
    {
        ...
        {
            Guard.ThrowIfNullOrEmpty(costInput, "Please enter the cost.", "costInput");
            Guard.ThrowIfNullOrEmpty(priceInput, "Please enter the price.", "priceInput");

            var cost = Guard.ThrowIfNotPositiveDecimal(costInput, "Cost must be a number and it must be bigger than zero.", nameof(costInput));
            var price = Guard.ThrowIfNotPositiveNonZeroDecimal(priceInput, "Price must be a number and it must be bigger than zero.", nameof(priceInput));
